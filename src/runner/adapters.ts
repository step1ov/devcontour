    ...
    return [
      ...
      ...(r.toolProfile
        ...
        : [
            ...
            // подсказки, и на пилоте он отвечал «файлы не прочитаны». Чтение
            // сохраняется, запись закрывает профиль прав ниже: на запись
            // открыт только временный каталог, сети нет.
            ...(r.review ? ['-c', 'features.shell_tool=true'] : []),
          ]),
