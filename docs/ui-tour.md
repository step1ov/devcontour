...
В новом workspace команда `start` сразу открывает три этапа: «Продукт», «Архитектура и стек», «Разработка». На первом видны сценарии и критерии, на втором — обоснование стека и интерактивные C1/C2. У каждой версии есть история и отдельное решение пользователя. Разработка подключается после двух согласований и настройки проекта на том же адресе. Подробный маршрут — [продукт → архитектура → разработка](staged-workflow.md).
